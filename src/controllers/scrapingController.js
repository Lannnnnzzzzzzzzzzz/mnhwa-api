...
export const getManhwaPopular = async (req, res) => {
  try {
    const url = "https://kiryuu03.com/manga/?status=&type=manhwa&order=popular";
...
export const getManhwaRecommendation = async (req, res) => {
  try {
    const urls = [
      "https://kiryuu03.com/manga/?page=1&type=manhwa&order=popular",
      "https://kiryuu03.com/manga/?page=1&type=manga&order=popular",
      "https://kiryuu03.com/manga/?page=1&type=manhua&order=popular",
    ];
...
export const getGenres = async (req, res) => {
  try {
    const url = "https://kiryuu03.com/manga/list-mode/";
    const html = await fetchPage(url);
    const $ = load(html);
...
export const getSearch = async (req, res) => {
  ...
  const url = `https://kiryuu03.com/?s=${searchId}`;
...
export const getSearchPage = async (req, res) => {
  ...
  const url = `https://kiryuu03.com/page/${pageNumber}/?s=${searchId}`;
...
export const getManhwaDetail = async (req, res) => {
  ...
  const url = `https://kiryuu03.com/manga/${manhwaId}`;
...
export const getManhwaOnGoing = async (req, res) => {
  const url =
    "https://kiryuu03.com/manga/?status=ongoing&type=manhwa&order=";
  try {
    const html = await fetchPage(url);
    const $ = load(html);
...
export const getChapter = async (req, res) => {
  ...
  const url = `https://kiryuu03.com/${chapterId}`;
